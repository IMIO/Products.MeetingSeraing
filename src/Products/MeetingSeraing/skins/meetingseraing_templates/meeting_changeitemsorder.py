...
#this script has a Manager proxy role because we want in some case to
#be able to change item order without having the permission to Modify the item
...
if catalogRes:
    ...
    context.plone_utils.addPortalMessage('UID not found!')
