    ...
    def performCustomWFAdaptations(self, meetingConfig, wfAdaptation, logger, itemWorkflow, meetingWorkflow):
        ...
        if wfAdaptation == 'returned_to_advise':
            ...
            if 'returned_to_advise' not in itemStates and 'returned_to_proposing_group' in itemStates:
                ...
                # return_to_advice_item_state = [adaptations.getValidationReturnedStates(meetingConfig)[-1]] + \
                #                               ['returned_to_proposing_group', 'presented', 'validatedByDG']
                # itemStates.addState('returned_to_advise')
                ...
                #     stateToClone = getattr(itemStates, stateToCloneStateId)
                ...
                # cloned_permissions_with_meetingmanager.update(
                #     RETURN_TO_ADVISE_CUSTOM_PERMISSIONS.get(meetingConfig.getItemWorkflow(), {}))
                #
                ...
                #     if stateName not in itemStates:
                #         continue
                #     # first specify that we can go to 'return_to_advise' from this state
                #     currentTransitions = list(itemStates[stateName].transitions)
                #     currentTransitions.append('return_to_advise')
                #     itemStates[stateName].transitions = tuple(currentTransitions)
                ...
                #     itemTransitions.addTransition(transitionName)
                #     transition = itemTransitions[transitionName]
                ...
                #     else:
                #         transition_title = 'goTo_returned_to_proposing_group_proposed'
